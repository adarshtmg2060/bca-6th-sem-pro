...
export const createFilter = (value: string): fabric.IBaseFilter | null => {
  ...
  switch (value) {
    ...
    case "pixelate":
      effect = new fabric.Image.filters.Pixelate({ blocksize: 8 });
      break;
    ...
    case "noise":
      effect = new fabric.Image.filters.Noise({ noise: 200 });
      break;
    ...
    case "threshold":
      //@ts-ignore
      effect = new fabric.Image.filters.Threshold({
        threshold: 128,
      });
      break;
    ...
    case "posterize":
      //@ts-ignore
      effect = new fabric.Image.filters.Posterize({ levels: 5 });
      break;
